...
The presently released version (0.3.10) will be superseded by version 0.4.0 which implements a new API (v1). (The current API is v0.) The goal for v1 remains to be mostly compatible with AdafruitGFX and TFT_eSPI. Version 0.4.0 will use API v0 by default but allow optional selection of v1 API.
